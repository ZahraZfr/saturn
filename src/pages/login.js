	...
	return (
		<div className="text-3xl text-center pt-14 rounded-full ">
			...
			<form className="flex justify-center mx-auto rounded-2xl flex-col mt-6 w-1/3 bg-gray-200 shadow-xl" onSubmit={handleSubmit}>
				...
				<button className="mb-28 flex items-center justify-center mt-7 mx-auto hover:text-white bg-green-400 hover:bg-green-800 px-36 py-5 w-32 rounded-full" type="submit" >Login</button>
			</form>
		</div>
	);
};
